...
define('LOCAL_VENDOR_DIR', LOCAL_ROOT . _DS_ . 'vendor');
define('LOCAL_CORE_DIR', LOCAL_VENDOR_DIR . _DS_ . 'core');
define('LOCAL_BASE_DIR', LOCAL_CORE_DIR . _DS_ . 'base');
define('LOCAL_APP_DIR', LOCAL_ROOT . _DS_ . 'app');
define('LOCAL_PUBLIC_DIR', LOCAL_ROOT . _DS_ . 'public');
...
define('LOCAL_PORTFOLIO_DIR', LOCAL_ROOT . _DS_ . 'portfolio');
...
define('HTTP_ROOT', str_replace(LOCAL_PATH_DIR, '', LOCAL_ROOT));
define('HTTP_APP_DIR', HTTP_ROOT . _DS_ . 'app');
define('HTTP_PUBLIC_DIR', HTTP_ROOT . _DS_ . 'public');
...
define('HTTP_PORTFOLIO_DIR', HTTP_ROOT . _DS_ . 'portfolio');
