...
<div class="container">
  <div class="row">
    <div class="col-sm-8">
      ...
      <form action="/admin/banners/post-add" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="banner_project" class="form-control js-banner-project-input">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <select name="banner_type" class="form-control js-banner-type-input">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="banner_title" value="" class="form-control js-banner-title-input" readonly>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="banner_thumb_url" value="" class="form-control js-banner-thumb-url-input" readonly>
              </div>
              <div class="form-group">
                  <label for="" class="form-label">Banner url &nbsp;/&nbsp; Ссылка на баннер:</label>
                <div class="js-banner-urls">
                  <input type="text" name="banner_url" value="" class="form-control js-banner-url-input" readonly>
                </div>
              </div>
            </div>
          </div>
